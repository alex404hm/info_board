                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      today ? "bg-emerald-500/[0.08]" : "bg-white/[0.03] hover:bg-white/[0.06]",
                    )}
                  >
                    <span className={cn("h-2.5 w-2.5 shrink-0 rounded-full", col.dot)} />
                    <div className="min-w-0 flex-1">
                      <p className="truncate text-[15px] font-semibold text-foreground-strong">{ev.title}</p>
                      {ev.location && (
                    ...
                    <div className="shrink-0 text-right">
                      <p className={cn("text-[12px] font-semibold tabular-nums", today ? "text-emerald-400" : "text-muted")}>
                        {today ? "I dag" : dateStr}
                      </p>
                      {!ev.allDay && (
                        <p className="text-[11px] tabular-nums text-subtle">{fmtTime(ev.start)}</p>
                      )}
                    </div>
                  </div>
                )
