    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {pages.map((page) => (
          <div
            key={page.id}
            className="group relative flex items-center justify-between rounded-xl border border-border/60 bg-surface px-6 py-4 transition-all hover:border-accent/30 hover:shadow-lg"
          >
            <div className="flex items-center gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-surface-soft text-muted-foreground">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground bg-surface-soft px-2 py-0.5 rounded">
                {page.key}
              </span>
              <Link
                href={`/admin/intranet/${page.id}`}
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-border/60 bg-surface-soft text-muted-foreground transition-colors hover:border-accent/40 hover:text-foreground"
              >
